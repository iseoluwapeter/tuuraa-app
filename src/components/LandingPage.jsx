...
export function LandingPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#239751] font-sans">
      ...
      />
      <div className="absolute inset-0 bg-linear-to-b from-[#0F3D2E]/85 via-[#0F3D2E]/70 to-[#0F3D2E]/92" />

      <div className="relative z-10 flex flex-col items-center px-6 text-center text-[#F5F3EE]">
        <img
          src="/icon-512.png"
          alt="Tuuraa"
          className="mb-6 h-22 w-22 rounded-[20px] shadow-[0_8px_24px_rgba(0,0,0,0.35)]"
        />

        <h1 className="mb-2 text-3xl font-bold tracking-tight">Tuuraa</h1>
        <p className="mb-8 max-w-75 text-[15px] leading-relaxed text-[#F5F3EE]/75">
        ...
        <div className="flex w-full max-w-70 flex-col gap-3">
          <Link
            to="/login"
            className="block rounded-lg bg-[#F5F3EE] px-4 py-3 text-[15px] font-bold text-[#0F3D2E] focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-[#F5F3EE]"
          >
            Get Started
          </Link>
